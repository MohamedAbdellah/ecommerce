                    ...
                    <div class="col-lg-9 col-md-8 col-6">
                        <div class="header-bottom-right">
                                    ...
                                    <ul>
                                        ...
                                        <li class="mega-menu-position top-hover"><a href="shop.php">category</a>
                                            <ul class="mega-menu">
                                                    ...
                                                    $categoryResult=$category->getAllData();
                                                    ...
                                                    if($categoryResult){
                                                       $categories=$categoryResult->fetch_all(MYSQLI_ASSOC); 
                                                        ...
                                                        foreach ($categories as $key => $value) {
                                                            ...
                                                            $subcategory->setCategoryId($value['id']);
                                                         ...
                                                         <li>
                                                            <ul>
                                                                ...
                                                                <?php
                                                                    ...
                                                                    <li><a href="shop.php">no SubCategory Available</a></li>
                                                               <?php
                                                                }
                                                                    ?>
                            ...
                            <div class="header-currency">
                                ...
                                ?>
                                    <span class="digit"><?php echo $_SESSION['user']->first . ' ' . $_SESSION['user']->last ?> <i class="ti-angle-down"></i></span>
